...
class Circularhelper {
  ...
  Future<List<CircularModel>> getCreatedCirculars(
    ...
    try {
      ...
      final url = 'api/MobileApp/teacher/$userId/CircularReport';
  ...
  Future<Map<String, dynamic>> deleteCirculars(circularId) async {
    try {
      ...
      final url = 'api/MobileApp/teacher/$userId/$circularId/RemoveCircular';
