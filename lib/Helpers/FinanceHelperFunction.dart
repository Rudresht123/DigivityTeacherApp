...
class FinanceHelperFunction {
  ...
  Future<List<PaymodeModel>> getPaymodes() async {
    ...
    if (response['success'] != null &&
      ...
      return innerList.map((item) => PaymodeModel.fromJson(item)).toList();
    }
  ...
  Future<List<Feeheadmodel>> getFeeheads() async {
    ...
    if (response['success'] != null &&
      ...
      return innerList.map((item) => Feeheadmodel.fromJson(item)).toList();
    }
    throw Exception("Failed to load feeheads.");
  }

  Future<String?> apifeecollectionreport(
    String reportName,
    ...
    try {
      ...
      final reportEndpoints = {
        ...
        'class-course-section-wise-collection-report':
            'apiclasssectioncollectionreport',
        ...
        "ledger-class-course-section-wise-fee-defaulter-report":"acledgerfeedefaulter",
      };
