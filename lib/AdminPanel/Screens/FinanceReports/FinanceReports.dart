  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: SimpleAppBar(titleText: 'Finance Reports', routeName: 'back'),
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                ReportCardBox(
                  ...
                  onTap: () {
                    context.pushNamed('student-fee-defaulter-report');
                  },
                ),
                const SizedBox(height: 16),
                ReportCardBox(
                  icon: Icons.event_note,
                  title: 'Sibling Wise Student Fee Defaulter Report',
                  onTap: () {
                    context.pushNamed('sibling-student-fee-defaulter-report');
                  },
                ),
              ],
            ),
